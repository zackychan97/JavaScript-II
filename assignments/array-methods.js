...
let fullNames = [];
  //needs for each so probably use for each, then going to need a push to the new array given to us
...
//et firstNamesAllCaps = [];
  //going to have to use the toUpperCase method at some point as well as .map
